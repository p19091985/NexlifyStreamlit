...
ON CONFLICT DO NOTHING;
INSERT INTO perfil_pagina_permissao (perfil_id, pagina_id) SELECT 1, pagina_id FROM pagina ON CONFLICT DO NOTHING;
INSERT INTO perfil_pagina_permissao (perfil_id, pagina_id) SELECT 3, pagina_id FROM pagina ON CONFLICT DO NOTHING;
